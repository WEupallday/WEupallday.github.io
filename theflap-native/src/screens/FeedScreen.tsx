...
export default function FeedScreen({ navigation }: any) {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.topbar}><Text style={styles.brand}>the<Text style={styles.brandBold}>FLAP</Text></Text></View>
...
const styles = StyleSheet.create({
  ...
  topbar: { alignItems: 'center', paddingVertical: 8, backgroundColor: theme.stripNavy },
  brand: { color: '#fff', fontSize: 22, fontWeight: 'bold' },
  brandBold: { color: theme.orange },
  ...
  composerCard: {
    ...
    marginHorizontal: 8, marginTop: 10, marginBottom: 12, overflow: 'hidden',
